<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('user/assets/css/pages/page-500.min.css')}}">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
...
<body class="vertical-layout vertical-menu-collapsible page-header-dark vertical-modern-menu 1-column blank-page blank-page" data-open="click" data-menu="vertical-modern-menu" data-col="1-column">
  ...
  <div class="row">
    ...
    <div class="col s12 center-align white">
      <img src="{{asset('user/assets/images/gallery/error-2.png')}}" alt="" class="bg-image-500">
      <h1 class="error-code m-0">Blocked</h1>
      <h6 class="mb-2">You're Blocked By Admin , Please Contact Admin</h6>
      <a class="btn waves-effect waves-light gradient-45deg-deep-purple-blue gradient-shadow mb-4" href="{{url('/dashboard')}}">Back
        To Dashboard</a>
    </div>
  </div>
</div>
